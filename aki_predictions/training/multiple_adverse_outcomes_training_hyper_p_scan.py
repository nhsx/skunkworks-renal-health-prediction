...
def main(output_dir, data_dir, steps):
    ...
    hyperparameter_scan = {"initial_learning_rate": [0.0001, 0.0003, 0.001, 0.003, 0.01]}
...
if __name__ == "__main__":
    ...
    file_handler = logging.FileHandler("{0}/{1}.log".format(artifacts_dir, f"{timestamp}_hyper_p_scan_log.txt"))

"""
Runs threshold sweep on a saved model, generated by multiple_adverse_outcomes_training. Accounting for
additonal context data.
...
if __name__ == "__main__":
    ...
    file_handler = logging.FileHandler(
        "{0}/{1}.log".format(artifacts_dir, f"{timestamp}_threshold_sweep_w_context_log.txt")
    )
